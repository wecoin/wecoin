...
Copyright (c) 2014 WeCoin developers
...
---------------------
	...
	cd src/
	make -f makefile.unix		# Headless WeCoin

See readme-qt.rst for instructions on building WeCoin-Qt, the graphical user interface.
...
---------------------
 ...
 libcrypto++ Cryptography      Provides implementations for cryptography in WeCoin
...
Notes
-----
The release is built with GCC and then `strip wecoind` to strip the debug
...
Security
--------
To help make your WeCoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, WeCoin should be built with a non-executable stack
