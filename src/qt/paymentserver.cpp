...
const QString BITCOIN_IPC_PREFIX("wecoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click wecoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start wecoin: click-to-pay handler");
    else
...
{
    // clicking on wecoin: URLs creates FileOpen events on the Mac:
